    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="loginn.html.php">SE CONNECTER <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="register_pfe.php">S'INSCRIRE <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#Social-Med">À PROPOS <span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </div>
